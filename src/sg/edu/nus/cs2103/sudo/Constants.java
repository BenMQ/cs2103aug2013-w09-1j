...
public class Constants {
	...
	public static final String MESSAGE_INVALID_DELETE = "Search term for " +
			"delete is invalid.\n";
	...
	public static final String MESSAGE_DISPLAY_FINISHED = "Displaying " +
			"finished tasks\n";
	...
	public static final String MESSAGE_ALREADY_INCOMPLETE = "The task is " +
			"already incomplete.\n";
	public static final String MESSAGE_NO_SEARCH_RESULTS = "No search results" +
			" found.\n";
	...
	public static final String MESSAGE_HISTORY_LOAD_ERROR = "Loading history " +
			"file error: file can not be found.";
	public static final String MESSAGE_SAVE_ERROR = "Saving file error: file " +
			"can not be found.";
